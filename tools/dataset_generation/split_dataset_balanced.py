...
INPUT_FILE = Path(
    "data/interim/generated_dataset/dataset_final.jsonl"
)

TRAIN_FILE = Path(
    "data/interim/generated_dataset/dataset_train.jsonl"
)

VAL_FILE = Path(
    "data/interim/generated_dataset/dataset_val.jsonl"
)

TEST_FILE = Path(
    "data/interim/generated_dataset/dataset_test.jsonl"
)
